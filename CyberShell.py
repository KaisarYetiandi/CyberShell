...
class ReverseShellBuilder(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CyberShell Payload - EmperorYetiandi")
    ...
    def setup_vbs_tab(self):
        ...
        self.tab_widget.addTab(vbs_tab, "📝 VBS Payload")
    ...
    def generate_chr_method(self):
        ...
        try:
            ...
            self.vbs_output.setPlainText(f"✅ Successfully generated Payload:\n📁 {filename}\n\n{vbs}")
    ...
    def show_about(self):
        ...
        msg = QMessageBox()
        msg.setIcon(QMessageBox.Icon.Information)
        msg.setWindowTitle("ℹ️ About CyberShell Payload")
